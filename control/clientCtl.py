...
class clientCtl():
    ...
    def login(self,userName,password,cb):
        msg=clientPackHandler.login(userName,password,self.MAC)
        client.client(json.dumps(msg),self.HOST,self.PORT,"login",cb,self.cbTmp)
